...
var PAGE_SUBS = {
  ...
  diet:       'Andhra food, smart calories.',
  brain:      'Train recall. Never lose a word.',
...
function renderPage() {
  ...
  var renderers = {
    ...
    diet:       typeof renderDiet       === 'function' ? renderDiet       : null,
    brain:      typeof renderBrain      === 'function' ? renderBrain      : null,
